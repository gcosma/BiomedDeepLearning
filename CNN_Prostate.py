...
Prostate = np.genfromtxt(root_datase + '/Prostate_Feat.txt', delimiter=",")
X = np.array(Prostate)
Prostate_1 = np.loadtxt(root_datase + '/Prostate_Target.txt', delimiter=",")
Y = np.array(Prostate_1)
#%%
...
#%%
model = Sequential()
model.add(Conv1D(32, 1, padding = "same", input_shape = (12600, 1)))
