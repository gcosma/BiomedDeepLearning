...
GLI_85 = np.genfromtxt(root_datase + '/GLI_85_Feat.txt', delimiter=",")
X = np.array(GLI_85)
GLI_85_1 = np.loadtxt(root_datase + '/GLI_85_Target.txt', delimiter=",")
Y = np.array(GLI_85_1)
#%%
...
#%%
model = Sequential()
model.add(Conv1D(32, 1, padding = "same", input_shape = (22283, 1)))
